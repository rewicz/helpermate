...
class HelpingPlanHelperPanel extends StatefulWidget {
  ...
  int id;
  HelpingPlanHelperPanel({required this.id});

  @override
  _HelpingPlanHelperPanelState createState() => _HelpingPlanHelperPanelState(id: id);
}

class _HelpingPlanHelperPanelState extends State<HelpingPlanHelperPanel> {
  int id;

  _HelpingPlanHelperPanelState({required this.id});
